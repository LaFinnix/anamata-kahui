...
export default async function WaiataPage({ params }: PageProps) {
  ...
  // Use admin client — the page does public reads only, and using
  // createServerSupabase here would call cookies() which throws
  // when the page is statically generated by generateStaticParams.
