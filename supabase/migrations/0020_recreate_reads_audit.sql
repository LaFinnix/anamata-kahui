-- Re-create the reads_audit trigger with the correct column names
-- (data_governance_log has category/title/body, not action/summary)
create or replace function public.reads_audit()
returns trigger as $$
begin
